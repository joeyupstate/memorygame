...
let secondSquaresAsClass = document.getElementsByClassName("secondBoardSquares");
let answer ;
let answer2;
...
function smith(){firstSquares.map(item => {
...
function patterGen(){
let firstsquareIterations = [firstSquares[0],firstSquares[1],firstSquares[2],firstSquares[3],firstSquares[4],firstSquares[5],firstSquares[6],firstSquares[7],firstSquares[8],firstSquares[9],firstSquares[10],firstSquares[11]];
